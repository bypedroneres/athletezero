...
function PrivacyPolicyScreen() {
  return (
    ...
    <ul>
        <li>Visit our website at <a href="https://athletezero.us">athletezero.us</a>, or any website of ours that links to this privacy notice</li>
...
<ol>
    ...
    <li><a href="#section9">DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></li>
...
<h3 id="section4">4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h3>
...
<h3 id="section5">5. HOW LONG DO WE KEEP YOUR INFORMATION?</h3>
...
<h3 id="section6">6. HOW DO WE KEEP YOUR INFORMATION SAFE?</h3>
...
<p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:contact@athletezero.us">contact@athletezero.us</a>.</p>
...
<h3 id="section9">9. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h3>
...
<p><strong>Category B</strong> - As long as the business remains active</p>
...
<p>Learn about how we use your personal information in the section, "<a href="#section2">HOW DO WE PROCESS YOUR INFORMATION?</a>"</p>

<p>Will your information be shared with anyone else?</p>

<p>We may disclose your personal information with our service providers pursuant to a written contract between us and each service provider. Learn more about how we disclose personal information to in the section, "<a href="#section3">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a>"</p>
...
<p><strong>CCA Privacy Notice</strong></p>
...
<p>Upon receiving your request, we will need to verify your identity to determine you are the same person about whom we have the information in our system. These verification efforts require us</p>

<p>To ask you to provide information so that we can match it with information you have previously provided us. For instance, depending on the type of request you submit, we may ask you to provide certain information so that we can match the information you provide with the information we already have on file, or we may contact you through a communication method (e.g., phone or email) that you have previously provided to us. We may also use other verification methods as the circumstances dictate.</p>
...
<ul>
    ...
    <li>You can designate an authorized agent to make a request under the CCA on your behalf. We may deny a request from an authorized agent that does not submit proof that they have been validly authorized to act on your behalf in accordance with the CCA.</li>
...
<p>To exercise these rights, you can contact us by email at <a href="mailto:contact@athletezero.us">contact@athletezero.us</a>, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>

<h3>Colorado Residents</h3>

<p>This section applies only to Colorado residents. Under the Colorado Privacy Act (CA), you have the rights listed below. However, these rights are not absolute, and in certain cases, we may decline your request as permitted by law.</p>
...
<p>To submit a request to exercise these rights described above, please email <a href="mailto:contact@athletezero.us">contact@athletezero.us</a>.</p>

<p>If we decline to take action regarding your request and you wish to appeal our decision, please email us at <a href="mailto:contact@athletezero.us">contact@athletezero.us</a>. Within forty-five (45) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions.</p>
...
<p>You may contact us by email at <a href="mailto:contact@athletezero.us">contact@athletezero.us</a>.</p>
...
<h3 id="section11">11. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h3>
      ...
      <h3 id="section12">12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h3>
      <p>You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please contact us at <a href="mailto:contact@athletezero.us">contact@athletezero.us</a>.</p>
      </div>
      <Footer />
    </div>
  );
